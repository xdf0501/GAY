...
public class FinalHttp {
    ...
    public HttpHandler get(String url, AjaxParams params, AjaxCallBack<? extends Object> callBack) {
        return sendRequest(httpClient, httpContext, new HttpGet(getUrlWithQueryString(url, params)), null, callBack);
    }

    public HttpHandler get(String url, Header[] headers, AjaxParams params, AjaxCallBack<? extends Object> callBack) {
    ...
    public HttpHandler post( String url, HttpEntity entity, String contentType, AjaxCallBack<? extends Object> callBack) {
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpPost(url), entity), contentType, callBack);
    }

    public <T> HttpHandler post(String url, Header[] headers, AjaxParams params, String contentType, AjaxCallBack<T> callBack) {
    ...
    public HttpHandler post( String url, Header[] headers, HttpEntity entity, String contentType,AjaxCallBack<? extends Object> callBack) {
    ...
    public HttpHandler put(String url, AjaxParams params, AjaxCallBack<? extends Object> callBack) {
        return put(url, paramsToEntity(params), null, callBack);
    }

    public HttpHandler put( String url, HttpEntity entity, String contentType, AjaxCallBack<? extends Object> callBack) {
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpPut(url), entity), contentType, callBack);
    }

    public HttpHandler put(String url,Header[] headers, HttpEntity entity, String contentType, AjaxCallBack<? extends Object> callBack) {
    ...
    //------------------delete 请求-----------------------
    public HttpHandler delete( String url, AjaxCallBack<? extends Object> callBack) {
        final HttpDelete delete = new HttpDelete(url);
        return sendRequest(httpClient, httpContext, delete, null, callBack);
    }

    public HttpHandler delete( String url, Header[] headers, AjaxCallBack<? extends Object> callBack) {
        final HttpDelete delete = new HttpDelete(url);
    ...
    protected <T> HttpHandler sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, AjaxCallBack<T> ajaxCallBack) {
        if(contentType != null) {
            uriRequest.addHeader("Content-Type", contentType);
        }

        HttpHandler handler=new HttpHandler<T>(client, httpContext, ajaxCallBack,charset);
